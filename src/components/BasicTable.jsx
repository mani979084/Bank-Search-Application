...
const BasicTable = ({ mock_data, setFav }) => {
            ...
            Cell: ({ row, selectedFlatRows }) => {
              return (
                <Checkbox
                  ...
                  checked={selectedFlatRows.some(
                    (item) => item.original.bank_id === row.original.bank_id
                  )}
                />
              );
            },
      ...
      <div className="mt-3 d-md-flex justify-content-center">
        <div className="me-md-2 mb-3 mb-md-0">
          ...
          <span>
            ...
            <input
              type="number"
              className="form-control d-inline text-primary"
        ...
        <select
          className="form-select me-2 w-auto float-start"
          id="select"
          value={pageSize}
